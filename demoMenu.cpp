...
#include "stdio.h"
#include "conio.h"
#include "time.h"//Need adjust for Linux
#define MAX_REF 100
#define MAX_FRAME 20
#define AAA 3
#define STRINT "%3d"
...
//--------------------------------------
//cac ham bo sung
void gotoxy(short x, short y)  //dua pointer toi vi tri minh muon
{//Need adjust for Linux
...
void setColor(int color) //doi mau ki tu 
{
...
//--------WINDOW----------------
void draw_window(int x1,int y1, int x2, int y2)//Need adjust for Linux
{
	char leftop = 0xc9;
